...
public interface CharacterProviderFull extends CharacterProvider {
	 ...
	 */
	public CharacterHandleFull createCharacter(Player player, String charName, RoleplayingSystem ruleSystem) throws IOException;
	 ...
	 */
	public List<CharacterHandleFull> getCharacters(Player player, RoleplayingSystem ruleSystem);
	 ...
	 * @return A list of characters in no granted order.
	 */
	public List<CharacterHandleFull> getCharacters(Player player);
